            ...
            try:
                ...
                for j, v in enumerate(versiones, 1):
                    ...
                    try:
                        ...
                        print("      ERROR capturando precios:", repr(e))
                        continue

            except Exception as e:
                stats["model_errors"] += 1
                print("  ERROR entrando al modelo:", repr(e))
                continue

        await browser.close()

    with open("volvo_modelos_versiones_precios.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        for r in resultados:
            try:
                ...
                saveCar('Volvo', datos, 'https://www.salazarisrael.cl/')
                stats["saved_ok"] += 1
        ...
        summary = {
            "status": "success",
            "source": "https://www.salazarisrael.cl/",
            **stats
        }
        ...
        print("✔ Listo: volvo_modelos_versiones_precios.json")
        print("RUN_OK")
        print(json.dumps(summary, ensure_ascii=False))
        sys.exit(0)
